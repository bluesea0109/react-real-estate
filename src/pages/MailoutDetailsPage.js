      ...
      <Modal open={showConsentModal} onClose={() => setShowConsentModal(false)} basic size="small" style={modalWidthStyle}>
        {details && (
          <div
            style={{
              margin: 'auto',
              width: `${iframeDimensions(details.postcardSize).width}px`,
              height: `calc(${iframeDimensions(details.postcardSize).height}px + 300px)`,
            }}
          >
            <Modal.Header style={{ padding: '40px 0px', display: 'flex' }}>
              <div style={modalPreviewText}>Preview</div>
