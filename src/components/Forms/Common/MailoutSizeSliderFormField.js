...
const MailoutSizeSliderFormField = ({ formType, listingType, formValues, setFormValues }) => {
  ...
  if (formType === 'team') {
    currentMailoutSize = formValues[listingType].mailoutSize;
    currentMailoutSizeMin = formValues[listingType].mailoutSizeMin || MIN;
    currentMailoutSizeMax = formValues[listingType].mailoutSizeMax || MAX;
  ...
  if (formType === 'agent') {
    currentMailoutSize = formValues[listingType].mailoutSize || 300;
    currentMailoutSizeMin = formValues[listingType].mailoutSizeMin || 100;
    currentMailoutSizeMax = formValues[listingType].mailoutSizeMax || 1000;
